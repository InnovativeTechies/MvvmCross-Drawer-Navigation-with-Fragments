...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "MvvmCross_FragmentNavigation_Demo.Droid.dll" comes first in this list. */
		"MvvmCross_FragmentNavigation_Demo.Droid.dll",
		...
		"MvvmCross_FragmentNavigation_Demo.Core.dll",
	};
